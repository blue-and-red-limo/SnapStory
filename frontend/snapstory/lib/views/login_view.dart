                ...
                children: [
                  ...
                  Align(
                      ...
                      child: SizedBox(
                        ...
                        child: TextButton(
                          ...
                          child: const Text('비밀번호를 잊었다면? 초기화하기', style: TextStyle(fontWeight: FontWeight.normal),),
                        ),
                      )
                  ),
                  const SizedBox(
                  ...
                  SizedBox(
                    ...
                    child: TextButton(
                      ...
                      child: const Text('로그인', style: TextStyle(fontSize: 23, fontWeight: FontWeight.normal)),
                    ),
                  ),
                  const SizedBox(
                    height: 3,
                  ...
                  Align(
                      ...
                      child: SizedBox(
                        ...
                        child: TextButton(
                          ...
                          child: const Text('계정이 없다면? 회원가입하기', style: TextStyle(fontWeight: FontWeight.normal),),
                        ),
                      )
                  ),
